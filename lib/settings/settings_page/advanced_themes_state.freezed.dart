...
/// @nodoc
@JsonSerializable()
class _$AdvancedThemeModelImpl
    with DiagnosticableTreeMixin
    implements _AdvancedThemeModel {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'AdvancedThemeModel'))
...
mixin _$AdvancedColors {
  ...
  /// Serializes this AdvancedColors to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of AdvancedColors
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
...
/// @nodoc
@JsonSerializable()
class _$AdvancedColorsLightImpl
    with DiagnosticableTreeMixin
    implements AdvancedColorsLight {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'AdvancedColors.light'))
...
/// @nodoc
@JsonSerializable()
class _$AdvancedColorsDarkImpl
    with DiagnosticableTreeMixin
    implements AdvancedColorsDark {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'AdvancedColors.dark'))
      ..add(DiagnosticsProperty('primary', primary))
      ..add(DiagnosticsProperty('secondary', secondary))
      ..add(DiagnosticsProperty('background', background));
  }
