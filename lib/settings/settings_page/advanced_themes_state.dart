...
class AdvancedThemeModel with _$AdvancedThemeModel {
  ...
  factory AdvancedThemeModel.fromJson(json) => _$AdvancedThemeModelFromJson(json);
}
...
class AdvancedColors with _$AdvancedColors {
  const factory AdvancedColors.light({
    ...
    @Default(Colors.blue) @MaterialColorConverter() final MaterialColor secondary,
    @Default(Colors.blue) @MaterialColorConverter() final MaterialColor background,
  }) = AdvancedColorsLight;
  const factory AdvancedColors.dark({
    @MaterialColorConverter() @Default(Colors.blue) final MaterialColor primary,
    @MaterialColorConverter() @Default(Colors.blue) final MaterialColor secondary,
    @MaterialColorConverter() @Default(Colors.blue) final MaterialColor background,
  }) = AdvancedColorsDark;
