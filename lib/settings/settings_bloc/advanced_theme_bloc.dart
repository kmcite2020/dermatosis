...
class AdvancedThemeBloc {
  ...
  late final descriptionFormField = RM.injectTextEditing(
    text: '',
    // advancedThemeModel.description,
    onTextEditing: (textEditing) {
